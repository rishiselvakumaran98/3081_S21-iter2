...
namespace csci3081 {
   ...
   class EntityBase : public IEntity {
      public:
         /**
          * @brief this is the default constructor for the entity base class. This serves as the base constructor for the EntityBase as their base class.
          */
         EntityBase(){}
         ...
         */
         ...
         /**
         * @brief function used to setup the ISubject sub of the observer
         * @param sub ISubject* pointer used to setup the observer
         */
