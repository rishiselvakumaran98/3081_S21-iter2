...
distance_traveled = 0;
  ...
  */
	...
	/**
	 * @brief this function does all of the movements updates for the Robot. through a series of calculation of Vector3D objects it moves the Robot from point A to point B, and selects when to drop and pick up the package calling the appropriate functions.
	 */
