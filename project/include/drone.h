...
/**
  ...
  */
	...
	/**
	 * @brief this function does all of the movements updates for the drone. through a series of calculation of Vector3D objects it moves the drone from point A to point B, and selects when to drop and pick up the package calling the appropriate functions.
	 */
